...
impl ChaCha20 {
    ...
    fn block(&mut self) -> [u32; 16] {
        ...
        for _ in 0..10 {
            ...
            x[12] = (x[12] ^ x[0]).rotate_left(16);
            x[8] = x[8].wrapping_add(x[12]);
            x[4] = (x[4] ^ x[8]).rotate_left(12);
            x[0] = x[0].wrapping_add(x[4]);
            x[12] = (x[12] ^ x[0]).rotate_left(8);
            x[8] = x[8].wrapping_add(x[12]);
            x[4] = (x[4] ^ x[8]).rotate_left(7);

            x[1] = x[1].wrapping_add(x[5]);
            x[13] = (x[13] ^ x[1]).rotate_left(16);
            x[9] = x[9].wrapping_add(x[13]);
            x[5] = (x[5] ^ x[9]).rotate_left(12);
            x[1] = x[1].wrapping_add(x[5]);
            x[13] = (x[13] ^ x[1]).rotate_left(8);
            x[9] = x[9].wrapping_add(x[13]);
            x[5] = (x[5] ^ x[9]).rotate_left(7);

            x[2] = x[2].wrapping_add(x[6]);
            x[14] = (x[14] ^ x[2]).rotate_left(16);
            x[10] = x[10].wrapping_add(x[14]);
            x[6] = (x[6] ^ x[10]).rotate_left(12);
            x[2] = x[2].wrapping_add(x[6]);
            x[14] = (x[14] ^ x[2]).rotate_left(8);
            x[10] = x[10].wrapping_add(x[14]);
            x[6] = (x[6] ^ x[10]).rotate_left(7);

            x[3] = x[3].wrapping_add(x[7]);
            x[15] = (x[15] ^ x[3]).rotate_left(16);
            x[11] = x[11].wrapping_add(x[15]);
            x[7] = (x[7] ^ x[11]).rotate_left(12);
            x[3] = x[3].wrapping_add(x[7]);
            x[15] = (x[15] ^ x[3]).rotate_left(8);
            x[11] = x[11].wrapping_add(x[15]);
            x[7] = (x[7] ^ x[11]).rotate_left(7);

            // Diagonal rounds
            x[0] = x[0].wrapping_add(x[5]);
            x[15] = (x[15] ^ x[0]).rotate_left(16);
            x[10] = x[10].wrapping_add(x[15]);
            x[5] = (x[5] ^ x[10]).rotate_left(12);
            x[0] = x[0].wrapping_add(x[5]);
            x[15] = (x[15] ^ x[0]).rotate_left(8);
            x[10] = x[10].wrapping_add(x[15]);
            x[5] = (x[5] ^ x[10]).rotate_left(7);

            x[1] = x[1].wrapping_add(x[6]);
            x[12] = (x[12] ^ x[1]).rotate_left(16);
            x[11] = x[11].wrapping_add(x[12]);
            x[6] = (x[6] ^ x[11]).rotate_left(12);
            x[1] = x[1].wrapping_add(x[6]);
            x[12] = (x[12] ^ x[1]).rotate_left(8);
            x[11] = x[11].wrapping_add(x[12]);
            x[6] = (x[6] ^ x[11]).rotate_left(7);

            x[2] = x[2].wrapping_add(x[7]);
            x[13] = (x[13] ^ x[2]).rotate_left(16);
            x[8] = x[8].wrapping_add(x[13]);
            x[7] = (x[7] ^ x[8]).rotate_left(12);
            x[2] = x[2].wrapping_add(x[7]);
            x[13] = (x[13] ^ x[2]).rotate_left(8);
            x[8] = x[8].wrapping_add(x[13]);
            x[7] = (x[7] ^ x[8]).rotate_left(7);

            x[3] = x[3].wrapping_add(x[4]);
            x[14] = (x[14] ^ x[3]).rotate_left(16);
            x[9] = x[9].wrapping_add(x[14]);
            x[4] = (x[4] ^ x[9]).rotate_left(12);
            x[3] = x[3].wrapping_add(x[4]);
            x[14] = (x[14] ^ x[3]).rotate_left(8);
            x[9] = x[9].wrapping_add(x[14]);
            x[4] = (x[4] ^ x[9]).rotate_left(7);
        }
        for i in 0..16 {
...
pub fn init_entropy(boot_info: &bootloader_api::BootInfo) {
    ...
    let rest = rdtsc
        .wrapping_add(pit_val as u64)
        .wrapping_add(apic_id as u64);
